...
#ifndef iass_queue_hh
#define iass_queue_hh
 ...
 * ! values of QUEUE_THRESHOLD_FRACT_DEN higher than 8 crash with sisgsev for hundred millions entries; why ?
...
public:
	iass_queue() {
		/* malloc first QUEUE_ARRAY_BLOCK_SIZE chunk of slots */
	...
	~iass_queue() {
		if (queue_size) std::cout << "warning ~iass_queue(), still " << queue_size << " entries in queue\n";
