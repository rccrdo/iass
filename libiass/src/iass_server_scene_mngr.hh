...
#ifndef iass_server_scene_mngr_hh
#define iass_server_scene_mngr_hh
...
class iass_server_scene_mngr : public iass_scene_mngr
{
/* functions */
public:
	iass_server_scene_mngr(iass_scene_impl_type t, unsigned int id);
	virtual ~iass_server_scene_mngr();

	void set_name(iass_cstring* name);
	iass_tunnel_idl* subscribe_scene_master(void);
	void unsubscribe_scene_master(void);

	bool subscribe_spectator(iass_tunnel_idl* spectator_tunnel);
...
#endif /*iass_server_scene_mngr_hh*/
